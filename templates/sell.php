...
<html lang="vi">
  ...
  <section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.56" alt="Bán nhà có chiến lược" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Cho người bán</span><h1>Bán nhà <span>có chiến lược</span></h1><p>Ethan kết hợp chiến lược định giá chuẩn xác và video marketing trực quan, giúp nhà của bạn tiếp cận đúng tệp người mua tiềm năng tại DFW.</p></div></section>
  ...
  <section class="subpage-quote-band">
    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.56" alt="Bất động sản DFW" />
