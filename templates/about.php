...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.58" alt="về Ethan" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Cố vấn địa ốc DFW của bạn</span><h1>Về <span>Ethan</span></h1><p>Tung Dao, known publicly as Ethan Dao Realtor, is an eXp Realty agent with Texas Ace Team serving Dallas, Fort Worth, and Arlington.</p></div></section>
<section class="page-section"><div class="content-split"><div class="portrait reveal"><span></span><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.58" alt="Ethan Dao" /></div><div class="reveal"><span class="h-kicker">Chuyên viên nổi bật</span><h2 class="h-section-title">Hiểu thị trường, mạnh <span>về truyền thông</span></h2><p>Ethan Dao Realtor (Tùng Đào) kết hợp kiến thức thị trường địa phương, dịch vụ song ngữ Việt-Anh và nội dung bất động sản trực quan trên mạng xã hội. Ethan mang đến thông tin rõ ràng, phân tích thẳng thắn và quy trình làm việc chắc chắn để bạn yên tâm giao dịch.</p><div class="stats-mini"><strong>38</strong><span>Tổng giao dịch trên Zillow</span><strong>12K</strong><span>Người theo dõi Facebook</span></div></div></div></section><section class="beyond">
        <div class="container">
      ...
      </section><section class="subpage-quote-band"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-houston.jpg?v=1.0.58" alt="Dallas-Fort Worth" /><div class="overlay"></div><blockquote class="reveal">“Tôi không chỉ là người môi giới — tôi là người <span>đồng hành</span> của bạn trên hành trình tìm nhà và xây dựng tương lai.”</blockquote></section><section class="page-section dark"><div class="container"><span class="h-kicker light reveal">Câu chuyện của tôi</span><h2 class="h-section-title reveal">Hành trình <span>của Ethan</span></h2><div class="timeline-vertical"><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Đến Mỹ & khởi đầu mới</h4><p>Sinh ra và lớn lên tại Việt Nam, Ethan đến Mỹ với quyết tâm xây dựng cuộc sống mới. Trải nghiệm của người nhập cư giúp Ethan hiểu sâu sắc những khó khăn mà cộng đồng Việt gặp phải khi tìm nhà tại Mỹ.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Bước vào ngành bất động sản</h4><p>Với niềm đam mê giúp đỡ cộng đồng, Ethan lấy bằng Real Estate License tại Texas và bắt đầu hành trình trở thành Realtor chuyên nghiệp tại khu vực Dallas-Fort Worth.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Gia nhập eXp Realty & Texas Ace Team</h4><p>Gia nhập eXp Realty — một trong những tập đoàn bất động sản lớn nhất thế giới — và trở thành thành viên Texas Ace Team, Ethan có thêm nền tảng công nghệ và mạng lưới để phục vụ khách hàng tốt hơn.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Chuyên viên nổi bật 2024 & 2025</h4><p>Được công nhận là chuyên viên nổi bật nhờ thành tích giao dịch ấn tượng, phản hồi 5 sao từ khách hàng và chiến lược marketing sáng tạo qua video, mạng xã hội.</p></div></div></div></div></section><section class="page-section" style="background: #f8f6f1;"><div class="container"><span class="h-kicker reveal">Giá trị cốt lõi</span><h2 class="h-section-title reveal">Điều Ethan <span>luôn giữ vững</span></h2><div class="value-grid"><div class="value-card reveal"><i class="ph-fill ph-diamond value-icon"></i><h3>Trung thực</h3><p>Luôn nói thật về tình trạng thị trường, giá trị thực của căn nhà và những rủi ro tiềm ẩn. Ethan tin rằng sự trung thực là nền tảng của mọi mối quan hệ lâu dài.</p></div><div class="value-card reveal"><i class="ph-fill ph-fire value-icon"></i><h3>Tận tâm</h3><p>Mỗi giao dịch đều được Ethan đối xử như thể đó là giao dịch của chính mình. Từ cuộc gọi đầu tiên đến ngày closing, bạn luôn là ưu tiên số một.</p></div><div class="value-card reveal"><i class="ph-fill ph-briefcase value-icon"></i><h3>Chuyên nghiệp</h3><p>Cập nhật kiến thức thị trường liên tục, sử dụng công nghệ hiện đại và quy trình có hệ thống để đảm bảo mọi giao dịch diễn ra suôn sẻ và hiệu quả.</p></div></div></div></section><section class="page-section dark"><div class="container"><span class="h-kicker light reveal">Con số nói lên tất cả</span><h2 class="h-section-title reveal">Thành tích <span>đáng tự hào</span></h2><div class="stats-band"><div class="stat-item reveal"><div class="stat-number">38<span>+</span></div><div class="stat-label">Giao dịch hoàn tất</div></div><div class="stat-item reveal"><div class="stat-number">5<span>★</span></div><div class="stat-label">Đánh giá trung bình</div></div><div class="stat-item reveal"><div class="stat-number">15K<span>+</span></div><div class="stat-label">Người theo dõi</div></div><div class="stat-item reveal"><div class="stat-number">100<span>%</span></div><div class="stat-label">Khách hàng hài lòng</div></div></div></div></section><section class="page-section"><div class="container"><div class="about-grid"><div class="reveal" style="display:flex;flex-direction:column;justify-content:center;"><span class="h-kicker">Sức mạnh tập đoàn</span><h2 class="h-section-title">eXp Realty & <span>Texas Ace Team</span></h2><p>Ethan là thành viên của eXp Realty — tập đoàn bất động sản đám mây lớn nhất thế giới với hơn 85,000 đại lý tại 24 quốc gia. Điều này mang lại cho bạn lợi thế vượt trội về công nghệ, mạng lưới và nguồn lực.</p><p>Texas Ace Team là đội ngũ tinh hoa tại DFW, chuyên hỗ trợ cộng đồng Việt và đa văn hóa. Với sự hậu thuẫn này, Ethan có đủ công cụ và kiến thức để mang lại kết quả tốt nhất cho bạn.</p></div><div class="reveal" style="display:flex;flex-direction:column;gap:20px;"><div class="value-card" style="text-align:left;"><i class="ph-fill ph-globe-hemisphere-west value-icon"></i><h3>Mạng lưới toàn cầu</h3><p>85,000+ đại lý tại 24 quốc gia, giúp kết nối người mua bán khắp nơi.</p></div><div class="value-card" style="text-align:left;"><i class="ph-fill ph-laptop value-icon"></i><h3>Công nghệ tiên tiến</h3><p>Nền tảng đám mây, CRM thông minh và công cụ marketing tự động.</p></div><div class="value-card" style="text-align:left;"><i class="ph-fill ph-medal value-icon"></i><h3>Đội ngũ xuất sắc</h3><p>Texas Ace Team — chuyên gia DFW với thành tích hàng đầu khu vực.</p></div></div></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ <span>sự tận tâm</span></h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form class="newsletter-form"><div class="nested-input"><input type="email" placeholder="Địa chỉ email của bạn..." required /><button class="btn-ink">Gửi thông tin</button></div><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
