...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.58" alt="về Ethan" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Chào bạn</span><h1>Tôi là <span>Ethan</span></h1><p>Tôi là môi giới bất động sản tại DFW, trực tiếp hỗ trợ khách hàng mua bán nhà quanh khu vực Dallas, Fort Worth và Arlington.</p></div></section>
<section class="page-section"><div class="content-split"><div class="portrait reveal"><span></span><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.58" alt="Ethan Dao" /></div><div class="reveal"><span class="h-kicker">Cách làm việc</span><h2 class="h-section-title">Tôi sẽ giúp <span>bạn thế nào</span></h2><p>Tôi trực tiếp đưa bạn đi xem nhà, phân tích ưu nhược điểm từng khu vực và giải thích từng dòng hợp đồng bằng tiếng Việt để bạn tự tin quyết định.</p><div class="stats-mini"><strong>38</strong><span>Giao dịch thực tế trên Zillow</span><strong>12K</strong><span>Người theo dõi Facebook</span></div></div></div></section><section class="beyond">
      ...
      </section><section class="subpage-quote-band"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-houston.jpg?v=1.0.58" alt="Dallas-Fort Worth" /><div class="overlay"></div><blockquote class="reveal">“Tôi thích giúp người Việt mình tìm được căn nhà phù hợp ở Texas.”</blockquote></section><section class="page-section dark"><div class="container"><span class="h-kicker light reveal">Câu chuyện</span><h2 class="h-section-title reveal">Kinh nghiệm của <span>tôi</span></h2><div class="timeline-vertical"><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Trải nghiệm tìm nhà</h4><p>Từng tự mình trải qua quá trình tìm nhà khó khăn ở Mỹ, tôi hiểu rõ những rào cản và vướng mắc mà người Việt thường gặp phải khi làm việc với giấy tờ.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Trở thành môi giới</h4><p>Tôi thi lấy bằng môi giới bất động sản tại Texas và dành toàn thời gian làm việc để hỗ trợ khách hàng khu vực DFW.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Công cụ và mạng lưới</h4><p>Gia nhập eXp Realty và Texas Ace Team, tôi tận dụng mạng lưới agent rộng lớn và nền tảng công nghệ mạnh mẽ để tìm kiếm nhà nhanh hơn cho bạn.</p></div></div><div class="timeline-step reveal"><div class="timeline-dot"></div><div><h4>Được khách hàng tin chọn</h4><p>Liên tục được công nhận nhờ số lượng giao dịch thành công và 100% đánh giá hài lòng từ những khách hàng đã làm việc trực tiếp.</p></div></div></div></div></section><section class="page-section" style="background: #f8f6f1;"><div class="container"><span class="h-kicker reveal">Cam kết</span><h2 class="h-section-title reveal">Nguyên tắc <span>làm việc</span></h2><div class="value-grid"><div class="value-card reveal"><i class="ph-fill ph-diamond value-icon"></i><h3>Nói thật</h3><p>Nếu nhà bị lỗi, tôi sẽ chỉ cho bạn. Tôi báo đúng giá thị trường, không hối thúc bạn mua nhà nếu không phù hợp.</p></div><div class="value-card reveal"><i class="ph-fill ph-fire value-icon"></i><h3>Phản hồi nhanh</h3><p>Tôi luôn trả lời tin nhắn ngay lập tức. Trong lúc đàm phán mua nhà, tốc độ là yếu tố quyết định.</p></div><div class="value-card reveal"><i class="ph-fill ph-briefcase value-icon"></i><h3>Có cơ sở</h3><p>Mọi lời khuyên của tôi đều dựa trên báo cáo dữ liệu thị trường thực tế thay vì cảm tính cá nhân.</p></div></div></div></section><section class="page-section dark"><div class="container"><span class="h-kicker light reveal">Kết quả</span><h2 class="h-section-title reveal">Thành quả <span>đạt được</span></h2><div class="stats-band"><div class="stat-item reveal"><div class="stat-number">38<span>+</span></div><div class="stat-label">Giao dịch hoàn tất</div></div><div class="stat-item reveal"><div class="stat-number">5<span>★</span></div><div class="stat-label">Đánh giá trung bình</div></div><div class="stat-item reveal"><div class="stat-number">15K<span>+</span></div><div class="stat-label">Người theo dõi</div></div><div class="stat-item reveal"><div class="stat-number">100<span>%</span></div><div class="stat-label">Khách hàng hài lòng</div></div></div></div></section><section class="page-section"><div class="container"><div class="about-grid"><div class="reveal" style="display:flex;flex-direction:column;justify-content:center;"><span class="h-kicker">Đội ngũ</span><h2 class="h-section-title">eXp Realty & <span>Texas Ace Team</span></h2><p>Ethan thuộc eXp Realty, có hơn 85,000 agent tại 24 nước. Hệ thống này giúp Ethan tìm listing, kết nối lender và hỗ trợ khách nhanh hơn.</p><p>Texas Ace Team tập trung vào cộng đồng Việt và đa văn hóa tại DFW.</p></div><div class="reveal" style="display:flex;flex-direction:column;gap:20px;"><div class="value-card" style="text-align:left;"><i class="ph-fill ph-globe-hemisphere-west value-icon"></i><h3>Mạng lưới</h3><p>85,000+ agent tại 24 nước.</p></div><div class="value-card" style="text-align:left;"><i class="ph-fill ph-laptop value-icon"></i><h3>Công cụ</h3><p>CRM, marketing và công cụ hỗ trợ giao dịch.</p></div><div class="value-card" style="text-align:left;"><i class="ph-fill ph-medal value-icon"></i><h3>Texas Ace Team</h3><p>Đội ngũ tại DFW hỗ trợ cộng đồng Việt.</p></div></div></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Nhận tin <span>nhà mới</span></h2><p>Ethan gửi email khi có listing tốt hoặc thay đổi giá đáng chú ý tại khu vực bạn quan tâm.</p><form data-static-form class="newsletter-form"><div class="nested-input"><input type="email" placeholder="Địa chỉ email của bạn..." required /><button class="btn-ink">Gửi thông tin</button></div><p class="form-success" hidden>Đã nhận. Ethan sẽ liên lạc lại sớm.</p></form></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Liên hệ</span><h2 class="h-section-title">Nói chuyện <span>với tôi</span></h2><p>Nhắn tin hoặc gọi trực tiếp, tôi sẽ nghe nhu cầu và đưa ra kế hoạch cụ thể cho bạn.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Nhắn tin cho Ethan</a></div></section></main>
    <footer class="footer">
      <div class="container">
