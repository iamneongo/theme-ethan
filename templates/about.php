...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.20" alt="về Ethan" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Cố vấn địa ốc DFW của bạn</span><h1>Về Ethan</h1><p>Tung Dao, known publicly as Ethan Dao Realtor, is an eXp Realty agent with Texas Ace Team serving Dallas, Fort Worth, and Arlington.</p></div></section>
...
<section class="page-section"><div class="content-split"><div class="portrait reveal"><span></span><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.20" alt="Ethan Dao" /></div><div class="reveal"><span class="h-kicker">Chuyên viên nổi bật</span><h2 class="h-section-title">Hiểu thị trường, mạnh về truyền thông</h2><p>Ethan Dao Realtor (Tùng Đào) kết hợp kiến thức thị trường địa phương, dịch vụ song ngữ Việt-Anh và nội dung bất động sản trực quan trên mạng xã hội. Ethan mang đến thông tin rõ ràng, phân tích thẳng thắn và quy trình làm việc chắc chắn để bạn yên tâm giao dịch.</p><div class="stats-mini"><strong>38</strong><span>Tổng giao dịch trên Zillow</span><strong>12K</strong><span>Người theo dõi Facebook</span></div></div></div></section><section class="beyond"><div class="container"><h2 class="h-section-title reveal">Không chỉ là bất động sản cùng Ethan</h2><article class="media-row reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg?v=1.0.20" alt="DFW neighborhoods" /><div><i></i><h3>Thông tin khu vực</h3><p>Hướng dẫn hằng tuần giúp bạn hiểu rõ khu vực trước khi đi xem nhà.</p></div></article><article class="media-row reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-ranch.jpg?v=1.0.20" alt="Texas home" /><div><i></i><h3>Hỗ trợ cộng đồng Việt</h3><p>Ethan giải thích cặn kẽ mọi thủ tục để gia đình Việt tự tin mua, bán và đầu tư bất động sản Mỹ.</p></div></article></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ sự tận tâm</h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form><input type="text" placeholder="Họ tên" /><input type="email" placeholder="Email" /><button class="btn-gold">Gửi thông tin</button><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form><label><input type="checkbox" /> <span>Tôi đồng ý để Ethan Dao liên hệ qua điện thoại, email và tin nhắn về dịch vụ bất động sản. Để dừng nhận tin, hãy trả lời "stop" bất cứ lúc nào hoặc trả lời "help" để được hỗ trợ. Bạn cũng có thể bấm liên kết hủy đăng ký trong email. Có thể phát sinh phí tin nhắn và dữ liệu. Tần suất tin nhắn có thể thay đổi. <a href="<?php echo esc_url(home_url('/contact/')); ?>">Chính sách bảo mật</a>.</span></label></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.20" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc cùng Ethan</h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
