...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot.jpg?v=1.0.20" alt="Kết nối ngay" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Contact</span><h1>Kết nối ngay</h1><p>Chia sẻ kế hoạch của bạn. Ethan sẽ vạch ra bước đi đầu tiên rõ ràng nhất.</p></div></section>
