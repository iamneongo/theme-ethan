...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot.jpg?v=1.0.58" alt="Kết nối ngay" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Contact</span><h1>Kết <span>nối ngay</span></h1><p>Chia sẻ kế hoạch của bạn. Ethan sẽ vạch ra bước đi đầu tiên rõ ràng nhất.</p></div></section>
<section class="page-section"><div class="content-split form-layout"><div class="split-media reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-headshot-hero.jpg?v=1.0.58" alt="Gửi tin nhắn" /></div><div class="form-panel reveal"><span class="h-kicker">Gửi tin nhắn</span><h2>Gửi tin nhắn</h2><p>Điền form bên dưới. Ethan sẽ tư vấn chi tiết về mua, bán hoặc đầu tư tại DFW.</p><form data-static-form><input type="text" placeholder="HỌ VÀ TÊN" /><input type="email" placeholder="EMAIL" /><input type="text" placeholder="SỐ ĐIỆN THOẠI" /><div class="custom-select" data-custom-select>  <div class="select-selected" data-select-trigger>BẠN QUAN TÂM ĐẾN...    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4.5l3 3 3-3"/></svg>  </div>  <div class="select-items" data-select-options>    <div data-value="Mua nhà">MUA NHÀ</div>    <div data-value="Bán nhà">BÁN NHÀ</div>    <div data-value="Đầu tư">ĐẦU TƯ</div>    <div data-value="Hợp tác đại lý">HỢP TÁC ĐẠI LÝ</div>  </div>  <input type="hidden" name="interest" value=""></div><textarea placeholder="TIN NHẮN"></textarea><button class="btn-ink">Gửi thông tin</button><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form></div></div></section><section class="page-section"><div class="container"><span class="h-kicker reveal">Câu hỏi nhanh</span><h2 class="h-section-title reveal">Trước khi <span>liên hệ</span></h2><div class="faq-list"><div class="faq-item reveal"><div class="faq-q">Tư vấn có mất phí không?</div><div class="faq-a"><p>Không. Buổi tư vấn đầu tiên hoàn toàn miễn phí. Ethan sẽ lắng nghe nhu cầu của bạn và đưa ra lời khuyên trung thực, không ràng buộc.</p></div></div><div class="faq-item reveal"><div class="faq-q">Ethan có làm việc vào cuối tuần không?</div><div class="faq-a"><p>Có. Bất động sản không có giờ hành chính. Ethan làm việc linh hoạt cả ngày thường, buổi tối và cuối tuần để phù hợp với lịch trình của bạn.</p></div></div><div class="faq-item reveal"><div class="faq-q">Tôi ở ngoài Dallas có được hỗ trợ không?</div><div class="faq-a"><p>Ethan hoạt động chủ yếu tại khu vực Dallas-Fort Worth. Nếu bạn đang tìm hiểu thị trường DFW từ xa (từ bang khác hoặc từ Việt Nam), Ethan hoàn toàn có thể tư vấn qua video call trước khi bạn đến.</p></div></div></div></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
