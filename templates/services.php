...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-houston.jpg?v=1.0.20" alt="dịch vụ" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Ethan hỗ trợ như thế nào</span><h1>dịch vụ</h1><p>Hỗ trợ chiến lược toàn diện cho việc mua, bán, đầu tư và định cư tại Dallas-Fort Worth.</p></div></section>
...
<section class="page-section"><div class="container"><div class="service-grid"><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg?v=1.0.20" alt="Mua nhà" /><div><h3>Mua nhà</h3><p>Cập nhật thị trường, tìm kiếm nhà, xem nhà, đàm phán, kiểm tra nhà, hỗ trợ vay vốn và đồng hành sau mua.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">bắt đầu mua nhà</a></div></article><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.20" alt="Bán nhà" /><div><h3>Bán nhà</h3><p>Định giá chuẩn xác, chuẩn bị nhà, chiến lược nội dung, quảng bá mạng xã hội, showing, đánh giá offer và hỗ trợ trọn vẹn đến ngày closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">bắt đầu bán nhà</a></div></article><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-ranch.jpg?v=1.0.20" alt="Đầu tư" /><div><h3>Đầu tư</h3><p>Phân tích nhu cầu khu vực, tiềm năng cho thuê, ưu đãi từ builder, góc nhìn bán lại và hoạch định danh mục đầu tư tại DFW.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">bắt đầu đầu tư</a></div></article></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ sự tận tâm</h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form><input type="text" placeholder="Họ tên" /><input type="email" placeholder="Email" /><button class="btn-gold">Gửi thông tin</button><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form><label><input type="checkbox" /> <span>Tôi đồng ý để Ethan Dao liên hệ qua điện thoại, email và tin nhắn về dịch vụ bất động sản. Để dừng nhận tin, hãy trả lời "stop" bất cứ lúc nào hoặc trả lời "help" để được hỗ trợ. Bạn cũng có thể bấm liên kết hủy đăng ký trong email. Có thể phát sinh phí tin nhắn và dữ liệu. Tần suất tin nhắn có thể thay đổi. <a href="<?php echo esc_url(home_url('/contact/')); ?>">Chính sách bảo mật</a>.</span></label></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.20" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc cùng Ethan</h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
        ...
        <div class="footer-cols"><div><h3>Ethan Dao</h3><a href="tel:+14699895786">(469) 989-5786</a><a href="mailto:ethandaorealtor@gmail.com">ethandaorealtor@gmail.com</a></div><div><h3>môi giới</h3><p>eXp Realty - Texas Ace Team</p><p>1431 Greenway Drive, Irving, TX 75038</p></div><div><h3>tìm kiếm</h3><p><a href="<?php echo esc_url(home_url('/browse-properties/')); ?>">tìm nhà</a></p><p><a href="<?php echo esc_url(home_url('/home-valuation/')); ?>">định giá nhà</a></p></div><div><h3>liên hệ</h3><p><a href="<?php echo esc_url(home_url('/contact/')); ?>">đặt lịch tư vấn</a></p><p><a href="<?php echo esc_url(home_url('/agent-collaborations/')); ?>">Hợp tác đại lýs</a></p></div></div>
