...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg?v=1.0.20" alt="Bất động sản Lavon" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Khu vực hoạt động</span><h1>Bất động sản Lavon</h1><p>Lavon là thị trường phù hợp với nhà mới xây, mức giá dễ tiếp cận, nhiều ưu đãi builder và không gian rộng hơn cho người mua.</p></div></section>
