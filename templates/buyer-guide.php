...
<html lang="vi">
  <head>
    ...
    <title>Hướng dẫn mua nhà | Ethan Dao</title>
    <meta name="description" content="A practical buyer roadmap for Dallas-Fort Worth homes." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-7.jpg?v=1.0.58" alt="Hướng dẫn mua nhà" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Tìm kiếm có chiến lược</span><h1>Hướng dẫn <span>mua nhà</span></h1><p>Hướng dẫn từng bước từ chuẩn bị tài chính, xem nhà, ra offer, inspection đến closing tại DFW.</p></div></section>
<section class="page-section"><div class="container"><h2 class="h-section-title reveal">Quy trình <span>mua nhà</span></h2><div class="process-timeline"><article class="reveal"><span>01</span><h3>Làm rõ nhu cầu</h3><p>Xác định khoảng giá, thời gian di chuyển, trường học, nhu cầu nhà mới xây và mục tiêu đầu tư trước khi đi xem nhà.</p></article><article class="reveal"><span>02</span><h3>Tài chính và chiến lược</h3><p>Kết nối ngân sách với lựa chọn lender, tiền cần chuẩn bị để closing, ưu đãi builder và sức mạnh offer.</p></article><article class="reveal"><span>03</span><h3>Tìm khu vực phù hợp</h3><p>So sánh các khu vực McKinney, Lavon, Garland, Wylie, Frisco, Dallas và những đô thị mới nổi tại DFW.</p></article><article class="reveal"><span>04</span><h3>Xem nhà và gặp builder</h3><p>Xem nhà với góc nhìn thực tế về layout, tình trạng, giá trị bán lại, ưu đãi và giá trị nâng cấp.</p></article><article class="reveal"><span>05</span><h3>Offer và đàm phán</h3><p>Xây dựng điều khoản, thời gian và contingency với hướng dẫn rõ ràng bằng tiếng Việt hoặc tiếng Anh.</p></article><article class="reveal"><span>06</span><h3>Từ inspection đến closing</h3><p>Theo dõi inspection, appraisal, hạn lender, final walk-through và các chi tiết trong ngày closing.</p></article></div></div></section><section class="page-section dark"><div class="content-split"><div class="split-media reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg?v=1.0.58" alt="New-build homes" /></div><div class="reveal"><span class="h-kicker light">Lợi thế nhà mới</span><h2 class="h-section-title">Phân tích ưu <span>đãi từ builder</span></h2><p>Hỗ trợ lãi suất, hỗ trợ chi phí closing, hay các gói nâng cấp chỉ thực sự giá trị khi phù hợp với kế hoạch dài hạn của bạn. Ethan sẽ giúp bạn đánh giá thỏa thuận một cách khách quan nhất.</p><a class="btn-outline-light" href="<?php echo esc_url(home_url('/buyer-information/')); ?>">Bắt đầu hồ sơ người mua</a></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ <span>sự tận tâm</span></h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form class="newsletter-form"><div class="nested-input"><input type="email" placeholder="Địa chỉ email của bạn..." required /><button class="btn-ink">Gửi thông tin</button></div><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
