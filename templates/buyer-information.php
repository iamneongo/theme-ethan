...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-5.jpg?v=1.0.20" alt="Thông tin người mua" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Bắt đầu tìm kiếm</span><h1>Thông tin người mua</h1><p>Chia sẻ mục tiêu mua nhà của bạn để Ethan có thể đề xuất khu vực, builder và căn nhà phù hợp nhất.</p></div></section>
