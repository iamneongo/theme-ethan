...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-5.jpg?v=1.0.56" alt="Thông tin người mua" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Bắt đầu tìm kiếm</span><h1>Thông tin <span>người mua</span></h1><p>Chia sẻ mục tiêu mua nhà của bạn để Ethan có thể đề xuất khu vực, builder và căn nhà phù hợp nhất.</p></div></section>
<section class="page-section"><div class="content-split form-layout"><div class="split-media reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg?v=1.0.56" alt="Thông tin nhu cầu mua nhà" /></div><div class="form-panel reveal"><span class="h-kicker">Thông tin nhu cầu mua nhà</span><h2>Thông tin nhu cầu mua nhà</h2><p>Hãy cho chúng tôi biết bạn đang tìm kiếm gì, ở khu vực nào và thời điểm bạn dự định chuyển nhà.</p><form data-static-form><input type="text" placeholder="Họ và tên" /><input type="email" placeholder="Email" /><input type="text" placeholder="Số điện thoại" /><input type="text" placeholder="Khu vực mong muốn" /><input type="text" placeholder="Ngân sách dự kiến" /><select><option>Bạn quan tâm đến...</option><option>Mua nhà</option><option>Bán nhà</option><option>Đầu tư</option><option>Hợp tác đại lý</option></select><textarea placeholder="Tin nhắn"></textarea><label><input type="checkbox" /> Tôi đồng ý để Ethan Dao liên hệ về dịch vụ bất động sản.</label><button class="btn-gold">Gửi thông tin</button><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form></div></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.56" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
