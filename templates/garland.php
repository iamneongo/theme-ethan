...
<html lang="vi">
  <head>
    ...
    <title>Bất động sản Garland | Ethan Dao</title>
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-garland.jpg?v=1.0.56" alt="Bất động sản Garland" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Khu vực hoạt động</span><h1>Bất động <span>sản Garland</span></h1><p>Garland có các khu dân cư lâu đời, kết nối thuận tiện đến Dallas và nhiều mức giá phù hợp cho người mua lẫn người bán.</p></div></section>
<section class="page-section"><div class="content-split"><div class="reveal"><span class="h-kicker">Hướng dẫn khu vực</span><h2 class="h-section-title">Góc nhìn thực <span>tế về Garland</span></h2><p>Garland có các khu dân cư lâu đời, kết nối thuận tiện đến Dallas và nhiều mức giá phù hợp cho người mua lẫn người bán.</p><div class="button-row"><a class="btn-ink" href="<?php echo esc_url(home_url('/browse-properties/')); ?>">Tìm nhà</a><a class="btn-outline-dark" href="<?php echo esc_url(home_url('/contact/')); ?>">Hỏi Ethan</a></div></div><div class="highlight-panel reveal"><p>Khu dân cư lâu đời</p><p>Di chuyển thuận tiện đến Dallas</p><p>Nhiều cơ hội đầu tư giá trị</p></div></div></section><section class="page-section dark"><div class="container"><h2 class="h-section-title reveal">Hoạt động <span>gần khu vực</span></h2><div class="property-filter"><button class="active" data-property-filter="all">Tất cả</button><button data-property-filter="for sale">Đang bán</button><button data-property-filter="sold">Đã bán</button><input type="search" data-property-search placeholder="Tìm theo thành phố hoặc địa chỉ" /></div><div class="listing-grid property-list"><article data-status="sold" data-city="garland"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-garland.jpg?v=1.0.56" alt="2610 Dodson St, Garland, TX 75042" /><span class="">Đã bán</span><div><h3>Đã bán</h3><p>2610 Dodson St, Garland, TX 75042</p><small>Đại diện người bán - 2 Phòng ngủ - 3 Phòng tắm - 1,542 Sq.Ft. - Đã bán 3 days ago</small></div></article></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ <span>sự tận tâm</span></h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form class="newsletter-form"><div class="nested-input"><input type="email" placeholder="Địa chỉ email của bạn..." required /><button class="btn-gold">Gửi thông tin</button></div><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form><label><input type="checkbox" /> <span>Tôi đồng ý để Ethan Dao liên hệ qua điện thoại, email và tin nhắn về dịch vụ bất động sản. Để dừng nhận tin, hãy trả lời "stop" bất cứ lúc nào hoặc trả lời "help" để được hỗ trợ. Bạn cũng có thể bấm liên kết hủy đăng ký trong email. Có thể phát sinh phí tin nhắn và dữ liệu. Tần suất tin nhắn có thể thay đổi. <a href="<?php echo esc_url(home_url('/contact/')); ?>">Chính sách bảo mật</a>.</span></label></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.56" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
