  ...
  <section class="property-content-section" style="background: #fff;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1fr 380px; gap: 64px; padding: 64px 24px;">
      ...
      <div class="property-info">
        ...
        <!-- Facts and Features -->
        <div class="property-features" style="margin-bottom: 64px;">
          <h2 style="font-family: var(--font-display); font-size: 24px; font-weight: 600; margin-bottom: 32px; color: var(--ink-strong);">Facts and features</h2>
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 32px 24px;">
        ...
        <div style="position: sticky; top: 120px; background: #fff; border: 1px solid rgba(0,0,0,0.08); padding: 32px; border-radius: 12px; box-shadow: 0 16px 40px rgba(0,0,0,0.04);">
          ...
          <div style="border-top: 1px solid var(--line); padding-top: 24px;">
            <div style="display: flex; align-items: center; gap: 16px;">
              ...
              <div>
                <strong style="display: block; font-size: 16px; color: var(--ink-strong); margin-bottom: 4px;">Ethan Dao</strong>
                <span style="display: block; font-size: 14px; color: var(--color-muted); margin-bottom: 4px;">Texas Ace Team - eXp Realty</span>
                <a href="tel:+14699895786" style="display: inline-block; font-size: 15px; color: var(--gold); font-weight: 600; text-decoration: none;">(469) 989-5786</a>
              </div>
            </div>
          </div>
        </div>
