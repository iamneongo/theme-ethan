...
<html lang="vi">
  <head>
    ...
    <title>Khu vực chuyên môn | Ethan Dao</title>
    <meta name="description" content="Explore Dallas-Fort Worth neighborhoods with Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg?v=1.0.58" alt="Khu vực chuyên môn" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Khu vực chuyên môn</span><h1>Khu vực <span>chuyên môn</span></h1><p>Khám phá các cộng đồng mà Ethan theo sát để giúp người mua, người bán và nhà đầu tư.</p></div></section>
<section class="page-section dark"><div class="container"><h2 class="h-section-title reveal">Khu vực <span>chuyên môn</span></h2><div class="area-grid"><a class="reveal" href="<?php echo esc_url(home_url('/mckinney/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-mckinney-tidal.jpg?v=1.0.58" alt="McKinney homes" /><div><h3>McKinney</h3><p>Cuộc sống trong cộng đồng quy hoạch bài bản, nét lịch sử và nhu cầu gia đình mạnh ở phía bắc Dallas.</p><span>Đọc thêm</span></div></a><a class="reveal" href="<?php echo esc_url(home_url('/lavon/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg?v=1.0.58" alt="Lavon homes" /><div><h3>Lavon</h3><p>Cộng đồng nhà mới xây, mức giá dễ tiếp cận và dư địa tăng trưởng.</p><span>Đọc thêm</span></div></a><a class="reveal" href="<?php echo esc_url(home_url('/garland/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-garland.jpg?v=1.0.58" alt="Garland homes" /><div><h3>Garland</h3><p>Khu dân cư lâu đời, thuận tiện đến Dallas và giá trị thực tế.</p><span>Đọc thêm</span></div></a><a class="reveal" href="<?php echo esc_url(home_url('/browse-properties/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Wylie homes" /><div><h3>Wylie</h3><p>Tiện ích ngoại ô, cộng đồng mới và sự thuận tiện gần hồ.</p><span>Đọc thêm</span></div></a><a class="reveal" href="<?php echo esc_url(home_url('/past-transactions/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-arlington.jpg?v=1.0.58" alt="Arlington homes" /><div><h3>Arlington</h3><p>Kết nối trung tâm DFW với nhiều phong cách nhà.</p><span>Đọc thêm</span></div></a><a class="reveal" href="<?php echo esc_url(home_url('/past-transactions/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-listing-midlothian.jpg?v=1.0.58" alt="Midlothian homes" /><div><h3>Midlothian</h3><p>Đất rộng hơn, nhà mới hơn và nhịp sống yên tĩnh ở phía nam DFW.</p><span>Đọc thêm</span></div></a></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ <span>sự tận tâm</span></h2><p>Đăng ký nhận thông tin nhà mới, phân tích thị trường và ưu đãi nổi bật nhất tại Dallas-Fort Worth.</p><form data-static-form class="newsletter-form"><div class="nested-input"><input type="email" placeholder="Địa chỉ email của bạn..." required /><button class="btn-ink">Gửi thông tin</button></div><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg?v=1.0.58" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc <span>cùng Ethan</span></h2><p>Bạn cần mua bán nhà tại Dallas-Fort Worth? Dù mua, bán hay đầu tư, Ethan sẽ đồng hành cùng bạn với chiến lược thực tế và sự tận tâm từ ngày đầu tiên đến khi closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
