...
<html lang="vi">
  <head>
    ...
    <title>tư vấn bán nhà | Ethan Dao</title>
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-8.jpg?v=1.0.20" alt="Tư vấn bán nhà" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Giá bán và định vị</span><h1>Tư vấn bán nhà</h1><p>Hãy bắt đầu bằng việc xác định mục tiêu, thời điểm, tình trạng nhà và bối cảnh khu vực trước khi chốt phương án rao bán.</p></div></section>
