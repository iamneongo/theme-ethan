...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg?v=1.0.20" alt="ghi chú bất động sản DFW" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">bài viết</span><h1>ghi chú bất động sản DFW</h1><p>Neighborhood insights, new-build notes, and market education for buyers and sellers.</p></div></section>
