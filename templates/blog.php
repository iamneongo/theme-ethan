...
<html lang="vi">
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg?v=1.0.56" alt="Ghi chú bất động sản DFW" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Bài viết</span><h1>Ghi chú bất <span>động sản DFW</span></h1><p>Ghi chú thị trường, hướng dẫn mua nhà mới xây và kiến thức bất động sản dành cho người mua và người bán.</p></div></section>
